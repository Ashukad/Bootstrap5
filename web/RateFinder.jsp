 ...
 <main class="mt-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4 jumbotron">
            ...
            <p><b>The Price Finder helps you to calculate your shipping charges for your service type needs.</b></p>
            <p><b>Charges will be based on the weight of the shipment in kgs or fractions thereof and may be assessible either on the gross weight of the shipment or the volume/dimensional weight of the shipment - whichever is higher.</b></p>

            <p><b>The chargeable weight may be expressed as fractions of a kg. such as 0.25 kgs or 0.5 kgs and may go upto 9999 kgs.
            </b></p>
            <p><b>To calculate the volume/dimensional weight of the shipment 
                <a href="VolumetricWeightCalculator.jsp">Click Here. </a></b></p>
            
                <form action="Rate2.jsp">
                <div class="row">
...
<div class="control-group">
    <div class="select">
        ...
        <div class="select__arrow"></div>
                ...
                <br>
                <div class="row">
                    <div class="col-md-6"><label>Type of Shipment</label></div>
                    <div class="col-md-6">
                       <select name="Cmdty" style="width: 180px">

                        <option value="099" selected> DOCUMENTS

                            <option value= "432"> NON DOCUMENTS
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <center>
                          <button type="submit" class="btn btn-primary btn-rounded">Find Rates</button>
                      </center>                
              </form>
