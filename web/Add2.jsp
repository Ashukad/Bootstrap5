<%-- 
    Document   : Add2
    Created on : Apr 22, 2018, 8:48:10 PM
    Author     : Ashitosh
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="border: 1px groove black" ><label><b>Delhi</b></label></div>
                        </div>
                        <div class="row" >
                            <div class="col-md-8" style="border: 1px groove black"><b>Address</b></div>
                            <div class="col-md-4" style="border: 1px groove black"><b>ZIPMENT EXPRESS LTD 4TH FLOOR, ELEGANCE TOWER, NON HIERARCHICAL COMMERCIAL CENTRE, PLOT NO.8, JASOLA DISTRICT CENTRE</b><label></label></div>                            
                        </div>
                        <div class="row" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"  style="border: 1px groove black"><label><b>110076</b></label></div>                            
                        </div>
