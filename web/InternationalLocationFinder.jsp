<%-- 
    Document   : InternationalLocationFinder
    Created on : Mar 15, 2018, 10:38:43 AM
    Author     : Ashitosh
--%>
 ...
 <main class="mt-5">
    <div class="row">
        ...
        <div class="col-md-4 jumbotron">
            <p><b>Location Finder-International</b></p>

            <p><b>The location finder helps you to locate a city of your choice from any of the countries we service.</b>

            </p>

            <p><b>Select a country of your choice in which your required city is located, from the list given below and then enter the city name.</b></p>
            ...
            <option value="VG"> VIRGIN ISLANDS (GB)
        ...
        <div class="select__arrow"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6"><input class="form-control form-control-sm" type="text"></div>
            </div>
        <div class="row">
               
            <div class="col-md-6"> <button type="button" class="btn btn-outline-primary btn-rounded waves-effect btn-sm" style="float: left">Submit</button></div>
                  
            <div class="col-md-6"><button type="button" class="btn btn-outline-primary btn-rounded waves-effect btn-sm" style="float: right;">Reset</button></div>
        </div>
          </form>
      </div> 
      <div class="col-md-4"></div> 
