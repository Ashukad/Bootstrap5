    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5">
                <form action="TransitTimeFinder.jsp">
                <div class="row">
                    ...
                    <div class="col-md-4" style="border: 1px groove black" ><label><b><%= (String)session.getAttribute("origin") %></b></label></div>
                        ...
                        <div class="row">
                            <div class="col-md-8"  style="border: 1px groove black"><b>Time</b></div>
                            <div class="col-md-4"  style="border: 1px groove black"><label><b><%= (String)session.getAttribute("time") %></b><p>days</p></label></div>                            
                        </div>
