<%-- 
    Document   : Add3
    Created on : Apr 22, 2018, 8:48:29 PM
    Author     : Ashitosh
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="border: 1px groove black" ><label><b>KOLKATA</b></label></div>
                        </div>
                        <div class="row" >
                            <div class="col-md-8" style="border: 1px groove black"><b>Address</b></div>
                            <div class="col-md-4" style="border: 1px groove black"><b>ZIPMENT EXPRESS LTD KANAK BUILDING 3RD FLOOR JAWAHARLAL NEHRU ROAD (OLD CHOWRINGEE ROAD)</b><label></label></div>                            
                        </div>
                        <div class="row" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"  style="border: 1px groove black"><label><b>700071</b></label></div>                            
                        </div>
