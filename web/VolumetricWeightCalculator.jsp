    ...
    <div class="row">
        ...
        <div class="col-md-4 jumbotron">
            <div class="row" style="background-color: grey">
                <div class="col-md-12">
                    <h5 style="color: white">Volumetric Weight Calculator</h5>
                </div>
            ...
            <form>
                <div class="container">
                    <div class="row">
                        <div class="col-md-5"><label>Dimension Unit</label></div>
                        <div class="col-md-7" align="center">
                            <select id="dimension" style="width: 200px;">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-5">
                                <label class="align-text-bottom">Length:</label>  
                            </div>
                            <div class="col-md-7">
                                <input type="number" id="length" onblur="lengthvalidate()"><br> 
                            </div>

                        </div>
                        <div class="row">
                            <div class="col-md-7"></div>
                            <div class="col-md-5"><p id="validationMessage" align="center" class="red-text font-bold" style="font-size:15px"></p></div>    

                        </div>
                        <div class="row">
                            <div class="col-md-5"><label>Breadth:</label></div>
                            <div class="col-md-7"><input type="number" id="breadth" onblur="breadthvalidate()"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-7"></div>
                            <div class="col-md-5"><p id="validationMessage2" align="center" class="red-text font-bold" style="font-size:15px"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-5"><label>Height:</label></div>
                            <div class="col-md-7"><input type="number" id="height" onblur="heightvalidate()"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-7"></div>
                            <div class="col-md-5"><p id="validationMessage3" align="center" class="red-text font-bold" style="font-size:15px"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6"><button type="button" class="btn btn-outline-primary btn-rounded waves-effect btn-sm" onclick="calculatevolumetricweight()" style="position: absolute;left: 0;">Calculate</button></div>
                            <div class="col-md-6 "><button type="button" class="btn btn-outline-primary btn-rounded waves-effect btn-sm" onclick="resetForm()" style="position: absolute; right: 0;">Reset</button></div>
                        </div>
                    <br><br>
                    <div class="row text-center" style="margin-bottom: 0px">
                        <div class="col-md-12"><p id="fieldmessage" class="red-text font-bold"></p></div>
                        </div>
                        <hr style="height:2px;border:none;color:#333;background-color:#333; margin-top: 0px" >
                        <div class="row">
                            <div class="col-md-8"><label>Total Volumetric Weight (Kg):</label></div>
                            <div class="col-md-4"><input type="text" readonly id="result"></div>
                        </div>
                    </div>
                </form>    
        </div>
