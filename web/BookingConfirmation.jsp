...
<body>
   ...
   <main class="mt-5">
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card card-cascade wider">
                ...
                <div class="card-body text-center">
                    <!--Title-->
                    <h4 class="card-title"><strong>Zipment Courier</strong></h4>
        ...
        <div class="col-md-6">
            <h1 class="text-left"><b>Thankyou for booking the courier with us </b></h1>

            <p>
            <ul>
                <li>Please Keep your shipment packed and ready</li>
                <li><p>For payment we have two modes.</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-8" style="border: 1px groove black" ><b>Your Token No is</b> </div>
                    <div class="col-md-4" style="border: 1px groove black" ><label><b><%= (String)session.getAttribute("token") %></b></label></div>
                        </div>
                        <div class="row" >
                            <div class="col-md-8" style="border: 1px groove black"><b>Booking Address</b></div>
                            <div class="col-md-4" style="border: 1px groove black"><b><%= (String)session.getAttribute("addr") %></b><label></label></div>                            
                        </div>
                        <div class="row" >
                            <div class="col-md-8" style="border: 1px groove black"><b>PickUpdate</b></div>
                            <div class="col-md-4" style="border: 1px groove  black"><label><b><%= (String)session.getAttribute("date") %></b></label></div>                            
                        </div>
                        <div class="row">
                            <div class="col-md-8"  style="border: 1px groove black"><b>Service Type</b></div>
                            <div class="col-md-4"  style="border: 1px groove black"><label><b><%= (String)session.getAttribute("service") %></b></label></div>                            
                        </div>
                        <div class="row" >
                            <div class="col-md-8" style="border: 1px groove black"><b>Total Pieces</b></div>
                            <div class="col-md-4" style="border: 1px  groove black"><b><%= (String)session.getAttribute("pieces") %></b></div>                            
                        </div>                        
                    </div>
                </div>
            </div>
